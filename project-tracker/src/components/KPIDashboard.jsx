  ...
  const stats = useMemo(() => {
    ...
    projects.forEach(p => {
       if (p.status !== 'Completed') {
           ...
           // Only process retention payable if the retention is not yet marked paid
           if (p.retentionPaid) {
              // Retention paid, do not count
           } else if (p.endDate && p.retentionPeriodMonths) {
           ...
           } else if (p.retentionAmount != null && p.retentionAmount > 0) {
              retentionPayableCount++;
           }
       }
    });
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
      ...
      <div className="bg-white dark:bg-slate-900/50 backdrop-blur-md border border-slate-100 dark:border-slate-800/80 p-3.5 sm:p-4 rounded-xl flex items-center justify-between shadow-sm group hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 hover:shadow-md hover:border-slate-200 dark:hover:border-slate-700/80 cursor-default">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] sm:text-xs text-slate-400 dark:text-slate-505 mt-1 truncate">{t('ongoingDesc')}</p>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900/50 backdrop-blur-md border border-slate-100 dark:border-slate-800/80 p-3.5 sm:p-4 rounded-xl flex items-center justify-between shadow-sm group hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 hover:shadow-md hover:border-slate-200 dark:hover:border-slate-700/80 cursor-default">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] sm:text-xs text-slate-400 dark:text-slate-505 mt-1 truncate">{t('retentionPayableDesc')}</p>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900/50 backdrop-blur-md border border-slate-100 dark:border-slate-800/80 p-3.5 sm:p-4 rounded-xl flex items-center justify-between shadow-sm group hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 hover:shadow-md hover:border-slate-200 dark:hover:border-slate-700/80 cursor-default">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] sm:text-xs text-slate-400 dark:text-slate-505 mt-1 truncate">{t('allocationDesc')}</p>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900/50 backdrop-blur-md border border-slate-100 dark:border-slate-800/80 p-3.5 sm:p-4 rounded-xl flex items-center justify-between shadow-sm group hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 hover:shadow-md hover:border-slate-200 dark:hover:border-slate-700/80 cursor-default">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] sm:text-xs text-slate-400 dark:text-slate-505 mt-1 truncate">{t('completedDesc')}</p>
        </div>
